...
<body>
  ...
  <footer>
    ...
    <section id="contact" class="container" style="margin-top:26px;">
    <div class="card" style="padding:18px">
      <h3>Contact & Booking (Example Only)</h3>
      <p>For inquiries or bookings regarding tours and activities featured, refer to the example contacts below:</p>
      <ul>
        <li><strong>Paragliding (Maasim):</strong> sample.paragliding@tourmail.com | +63 900 123 4567</li>
        <li><strong>Tuka Marine Park (Kiamba):</strong> sample.tuka@beachexample.com | +63 900 234 5678</li>
        <li><strong>Whitewater Tubing (Maitum):</strong> sample.tubing@adventuremail.com | +63 900 345 6789</li>
      </ul>
      <p><em>Note: These are sample contacts only for demonstration purposes.</em></p>
    </div>
  </section>
